...
A clean and modular Laravel 8.0 starter template to kickstart scalable web applications. This boilerplate includes essential configurations, folder structures, and environment setup to streamline development and onboarding.

## 🚀 Features

- Laravel 8.0 base setup
